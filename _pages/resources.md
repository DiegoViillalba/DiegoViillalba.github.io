---
title: "Research Internships & Academic Profile Resources"
permalink: /resources/
author_profile: true
header:
  overlay_filter: 0.5
...
* [Internship Databases](#general-internship-databases)
* [University Programs](#university--institute-specific-programs)
* [Opportunities for Mexican Students](#programs-for-mexican-students)
* [Academic Profile Building](#preparing-your-academic-profile)
* [Correspondence Guide](#writing-to-a-researcher-the-first-contact)
...
| :--- | :--- | :--- |
| **Pathways to Science** | Comprehensive database for funded programs (REUs). | [Visit Website](https://www.pathwaystoscience.org/Discipline.aspx?sort=ENG-Physics_Physics) |
| **Physics Today Jobs** | Academic, national labs, and industry-adjacent roles. | [Visit Website](https://jobs.physicstoday.org/jobs/intern/) |
| **Gradcracker** | Science and physics placements in UK and Europe. | [Visit Website](https://www.gradcracker.com/search/science/physics-work-placements-internships) |
...
* **MIT – Summer Research Opportunities** A central hub for MIT-sponsored summer programs in physics and related fields.  
    [Explore Programs](https://sps.mit.edu/summer-research-opportunities/)
* **University of Oxford – Physics Summer Internships** Undergraduate research internships within Oxford’s active research groups.  
    [Explore Programs](https://www.physics.ox.ac.uk/research/summer-internships-undergraduates)
* **Stanford University – External Opportunities** A curated list of external research programs recommended by Stanford Physics.  
    [Explore Programs](https://physics.stanford.edu/undergraduate/undergraduate-research/research-opportunities-outside-stanford)
* **Project YL – International Research Programs** Community-driven collection with a strong emphasis on European internships.  
    [Explore Programs](https://projectyl.github.io/inter/)
...
* **AMEXCID** Government-supported scholarships and international exchange offers for Mexican nationals.  
    [Link to Offerings](https://www.gob.mx/amexcid/acciones-y-programas/oferta-para-mexicanos)
* **Mitacs (Canada)** Highly recommended for research stays in Canada (Globalink Research Internship).  
    [Link to Mitacs](https://www.mitacs.ca/)
* **DGECI (Mexico-UNAM)** University specific scolarships for research and study abroad.
    [Lint to Site](https://www.unaminternacional.unam.mx/es/movilidad/estudiantil)
...
* **LaTeX Template:** [Harshibars Resume (Overleaf)](https://www.overleaf.com/latex/templates/harshibars-resume/sbcyynmtpnyd) – A clean, academic-oriented design.
* **Guidelines:** [How to Write an Academic CV](https://grad.illinois.edu/professional-development/applying-jobs/cv-or-resume) – Key differences between a CV and a resume.

### Academic Website
Centralize your work and progress through a professional digital presence.
* **AcademicPages:** [GitHub Template](https://github.com/academicpages/academicpages.github.io) – Jekyll-based template for researchers.
* **BootstrapMade:** [Personal Templates](https://bootstrapmade.com/bootstrap-personal-templates/) – High-customization layouts.
